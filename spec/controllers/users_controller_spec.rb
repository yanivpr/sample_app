...
describe UsersController do
  ...
  describe "GET 'show'" do
   before(:each) do
    ...
    it "should find the right integration_test_sign_in(user)user" do
	    get :show, :id => @user
  ...
  describe "GET 'index'" do
	...
	describe "for signed-in users" do
		...
		before(:each) do
			...
			second = Factory(:user, :email => "other2@example.com")
			third = Factory(:user, :email => "other3@example.com")
		...
		it "should paginate users" do
			...
			response.should_not have_selector("span", :content => "Previous")
  ...
  describe "authentication of edit/update pages" do
	...
	describe "for signed-in users" do
		...
		before(:each) do
 			wrong_user = Factory(:user, :email => "some@othermail.com")
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "as a non-signed_in user" do
	it "should deny access" do
